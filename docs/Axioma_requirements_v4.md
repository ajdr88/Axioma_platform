...
**Supersedes:** Axioma_requirements_v3.md
**Companion documents:** Axioma_implementation_v4.md, Axioma_architecture_review.md, Axioma_stage_tracking_amendment.md
**Change basis:** This revision folds in all twelve prioritized findings from the architecture review (Rev B, carried forward) plus the Rev C addition: Program & Subsystem Lifecycle Tracking (new FR-PM group, §2.5 and §5.8), detailed in Axioma_stage_tracking_amendment.md. Material changes are flagged inline as **[REV-B]** or **[REV-C]** with the section that motivated them.
